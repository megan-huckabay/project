    ...
    <div className="about-container about-page">
      ...
      <div className="fun-container">
        ...
        <div className="art-section">
          <h2><strong>The Art of Pour Painting</strong></h2>
        ...
        <div className="helping-section">
          <h2><strong>Extending a Helping Hand</strong></h2>
        ...
        <div className="nature-section">
          <h2><strong>Embracing Nature's Beauty</strong></h2>
        ...
        <div className="power-section">
          <h2><strong>Learning How to Code!!</strong></h2>
      ...
      <div className="dream-container">
        ...
        <div className="future-section">
          <h2><strong>What's In My Distant Future Plans!!</strong></h2>
