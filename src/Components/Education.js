    ...
    return (
        <div className="education-container education-page">
            ...
            <div className="school-section">
                ...
                <h3><strong>Full-stack Software Development Program</strong></h3>
                <p><b>February 2023 - October 2023</b></p>
                <p>
                    <b>Graduated with proficiency in front-end and back-end development,<br />
                        including technologies such as HTML, CSS, JavaScript, <br />and
                        database management.</b>
                </p>
                <h3><strong>GCA (General Coding Assessment)</strong></h3>
                <p><b>Score: 706</b></p>
            </div>
